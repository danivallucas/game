module.exports = {
  generalParams: {
    ...
    DRIVING_MIN_VEL: 300, //30, // (km/h) velocidade térrea mínima (player próximo a MAX_ESTIMATED_ENERGY)
    DRIVING_MAX_VEL: 3000, //300; // (km/h) velocidade térrea máxima (player com START_ENERGY)
    ...
    DIRECT_VEL: 100000, //1000; // (km/h) fixa em 1.000 km/h (avião)
