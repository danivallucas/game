...
public class RouteLeg {
    ...
    public void draw(MainActivity context, LatLng latLng, int pointIndex) {
        ...
        endPolyline = context.mMap.addPolyline(new PolylineOptions().width(30).color(0xCC3B7AC9).jointType(JointType.ROUND).pattern(pattern).endCap(new CustomCap(BitmapDescriptorFactory.fromResource(R.drawable.point),32)).add(latLng3, latLng4));
